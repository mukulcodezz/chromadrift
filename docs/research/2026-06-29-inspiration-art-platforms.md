...
CHROMADRIFT — a light, editorial, gallery-catalogue site for a 4,444-plate generative
...
7. **Avoided trope to flag:** the gm.studio "total volume / owners / hold time" **stat bar** — exactly the
   generic web3-dashboard look CHROMADRIFT should NOT adopt.

---

## Concrete refinements for CHROMADRIFT
...
8. **Gallery-label hero copy.** Kicker → Bodoni headline → one sentence → one CTA (Proof rhythm). e.g.
   kicker "GENERATIVE COLOUR EDITION" / headline *"CHROMADRIFT"* / "Four thousand four hundred and forty-four
