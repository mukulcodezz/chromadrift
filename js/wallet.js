/**
 * CHROMADRIFT - Solana wallet adapter
...
function bindProviderEvents(wallet, name) {
  if (wallet._chromadriftBound) return;
  wallet._chromadriftBound = true;
...
function openWalletInstallModal() {
  ...
  modal.querySelector(".wallet-modal__sub").textContent =
    "No Solana wallet detected. Install one to mint on CHROMADRIFT.";
